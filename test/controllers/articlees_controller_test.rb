...
class ArticleesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articlee" do
    assert_difference("Articlee.count") do
      post articlees_url, params: { articlee: { description: @articlee.description, string: @articlee.string, text: @articlee.text, title: @articlee.title } }
    end
  ...
  test "should update articlee" do
    patch articlee_url(@articlee), params: { articlee: { description: @articlee.description, string: @articlee.string, text: @articlee.text, title: @articlee.title } }
