...
class SciencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create science" do
    assert_difference("Science.count") do
      post sciences_url, params: { science: { description: @science.description, title: @science.title } }
    end
  ...
  test "should update science" do
    patch science_url(@science), params: { science: { description: @science.description, title: @science.title } }
